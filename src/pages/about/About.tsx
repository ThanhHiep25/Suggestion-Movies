...
const AboutUs: React.FC = () => {
    ...
    return (
        <div
            className="min-h-screen bg-gray-900 text-white py-16 px-4 md:px-8 mt-[-80px] flex flex-col justify-center items-center overflow-hidden"
        >
            {/* H1 Title - luôn visible hoặc animate khi load trang */}
            <motion.h1
                className="text-4xl md:text-6xl mt-10 font-extrabold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-purple-600"
